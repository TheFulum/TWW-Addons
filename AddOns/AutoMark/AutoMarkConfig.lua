...
-- Custom/Override Mobs
			...
			if n > 0 then
				...
				for k,v in ipairs(npcTable) do
					...
					local radio = rootDescription:CreateRadio("|cFF" .. c .. v[1] .. " " .. v[2] .. "|r",
					...
					radio:SetTooltip(function(tooltip, elementDescription)
						...
						local buffer = MyAddon.GetMarksString(id,false,true)
						GameTooltip_AddNormalLine(tooltip,"Marks: " .. buffer)
